...
```{r}
trunc_model_results = read_csv("outputs_truncated/all_model_results.csv") %>%
  mutate(analysis_type = "truncated")

complete_model_results = read_csv("outputs_full/all_model_results.csv") %>%
...
psim = rbind(read_csv("outputs_full/all_lexical_results.csv")%>% 
               filter(Dimension == 50 & Type == "alpha_0.5_s2v") %>%
               mutate(analysis_type = "full"),
             read_csv("outputs_truncated/all_lexical_results.csv")%>% 
               filter(Dimension == 50 & Type == "alpha_0.5_s2v") %>%
               mutate(analysis_type = "truncated")) %>%
