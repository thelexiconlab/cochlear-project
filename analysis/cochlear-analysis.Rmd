...
```{r}
trunc_model_results = read_csv("analysis trunc/outputs/complete_model_results.csv") %>%
  mutate(analysis_type = "truncated")

complete_model_results = read_csv("analysis without rep/outputs/complete_model_results.csv") %>%
...
psim = rbind(read_csv("lexical_results_no_rep.csv")%>% mutate(analysis_type = "full"),
             read_csv("lexical_results_no_rep_trunc.csv")%>% mutate(analysis_type = "truncated")) %>%
