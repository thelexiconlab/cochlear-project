...
similaritypath =  'data/lexical_data/NEW/USE_semantic_matrix.csv'
frequencypath =  'data/lexical_data/NEW/USE_frequencies.csv'
phonpath = 'data/lexical_data/NEW/USE_phonological_matrix.csv'
vocabpath = 'data/lexical_data/NEWvocab.csv'

'''
# normspath =  'data/norms/animals_snafu_scheme_vocab.csv'
# similaritypath =  '../data processing/300_dim_results/Lexical Data/speech2vec/semantic_matrix.csv'
# frequencypath =  '../data processing/300_dim_results/Lexical Data/speech2vec/frequencies.csv'
# phonpath = '../data processing/300_dim_results/Lexical Data/speech2vec/phon_matrix.csv'
# vocabpath = 'data/lexical_data/vocab.csv'

# normspath =  'data/norms/animals_snafu_scheme_vocab.csv'
# similaritypath =  '../data processing/300_dim_results/Lexical Data/word2vec/semantic_matrix.csv'
# frequencypath =  '../data processing/300_dim_results/Lexical Data/word2vec/frequencies.csv'
# phonpath = '../data processing/300_dim_results/Lexical Data/word2vec/phon_matrix.csv'
# vocabpath = 'data/lexical_data/vocab.csv'
'''
