...
def prepareData(path):
    ...
    labels = pd.read_csv("/Users/mkang2/Library/CloudStorage/OneDrive-BowdoinCollege/Desktop/cochlear-project/forager/data/lexical_data/50_dim_lexical_data/only_s2v/frequencies.csv", names=['word', 'logct', 'ct']) 
